        ...
        env_defs: list[JobDefinition] = [
            {
                ...
                "evidence_layer": EvidenceLayer.LOCAL_VALIDATION,
                "command": ("bash", "scripts/ubuntu_train_lumen_full_pipeline.sh", "--prepare-only"),
                "description": "Build the pinned container and verify GPU, environment, datasets, and run config without training.",
            ...
            },
            {
                ...
                "command": ("bash", "scripts/ubuntu_train_lumen_full_pipeline.sh"),
                "description": "Run the pinned one-click SFT, preference, evaluation, and adapter-GGUF pipeline.",
                "outputs": (".local/ubuntu_finetune_runs",),
                "requires_confirmation": True,
            },
            {
                "id": "hf-resolve",
