...
The current device checkpoint includes one exact DEBUG-only physical model/tool diagnostic pass. Separately, a no-upload signed Release archive/export with complete Lumen/MSAL/llama UUID coverage is bound to source `635c7b0c2f7f2ee6a697b2622d025153924a7c35`, build `20260810044413`. Neither checkpoint is upload, TestFlight, processing, or App Store acceptance evidence; see `docs/VALIDATION.md` for the exact provenance and remaining Release gaps.
