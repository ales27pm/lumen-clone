    ...
    private static func snapshot() -> DiagnosticsSnapshot {
        DiagnosticsSnapshot(
            ...
            background: BackgroundDiagnosticsSnapshot(
                ...
                continuedProcessingRegistrationIdentifier: TriggerScheduler.continuedProcessingRegistrationIdentifier,
                continuedProcessingLastSubmittedIdentifier: nil,
                continuedProcessingRegistrationErrorDomain: nil,
                continuedProcessingRegistrationErrorCode: nil,
                continuedProcessingSubmitErrorDomain: nil,
                continuedProcessingSubmitErrorCode: nil,
                continuedProcessingRegisteredBeforeLaunchCompletion: nil,
                continuedProcessingProvisioningEntitlementPresent: nil,
                continuedProcessingExpectedEntitlementValue: nil,
