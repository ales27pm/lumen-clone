...
struct ThirdPartyNoticesTests {
    @Test func bundledNoticesCoverEveryShippedRuntimeDependencyAndSelectableModelFamily() {
        ...
        #expect(notices.contains("903587d86a2e8b3f05bb0fab9d42338c0add0167"))
        #expect(notices.contains("dda08641ab02d0a23f0cceff342846bb94d5fa02"))
        ...
        #expect(!notices.contains("f8781f415a0ff87ea3f3a2119ab2ad96fae8fcf2"))
