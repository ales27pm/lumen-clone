...
final class DiagnosticsProvider {
    ...
    func cachedSnapshot() -> DiagnosticsSnapshot {
        ...
        let background = BackgroundDiagnosticsSnapshot(
            ...
            continuedProcessingRegistrationIdentifier: BackgroundContinuedProcessingCoordinator.shared.lastRegistrationIdentifier,
            continuedProcessingLastSubmittedIdentifier: BackgroundContinuedProcessingCoordinator.shared.lastSubmittedIdentifier,
            continuedProcessingRegistrationErrorDomain: BackgroundContinuedProcessingCoordinator.shared.lastRegistrationErrorDomain,
            continuedProcessingRegistrationErrorCode: BackgroundContinuedProcessingCoordinator.shared.lastRegistrationErrorCode,
            continuedProcessingSubmitErrorDomain: BackgroundContinuedProcessingCoordinator.shared.lastSubmitErrorDomain,
            continuedProcessingSubmitErrorCode: BackgroundContinuedProcessingCoordinator.shared.lastSubmitErrorCode,
            continuedProcessingRegisteredBeforeLaunchCompletion: BackgroundContinuedProcessingCoordinator.shared.lastRegistrationBeforeAppLaunchCompletion,
            continuedProcessingProvisioningEntitlementPresent: BackgroundDiagnosticsEntitlements.provisioningProfileContainsContinuedProcessingEntitlement(),
            continuedProcessingExpectedEntitlementValue: BackgroundDiagnosticsEntitlements.expectedContinuedProcessingEntitlementValue(),
