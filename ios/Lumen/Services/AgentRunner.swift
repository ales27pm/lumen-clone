...
enum AgentRunner {
    ...
    private static func runHeadless(
        ...
        let grounding = try? await LegacyTurnGroundingCoordinator.shared.build(userMessage: executionPrompt, conversationID: nil, turnID: nil, history: [], modelContext: context, isBackground: true, task: .backgroundTrigger, role: "headless-trigger")
